...
VS 2012 개발 환경을 오픈하고 ASP.net MVC 4 web 프로젝트를 생성합니다: VC_Spread_Web
...
FarPoint.Mvc.Spread.dll, FarPoint.Web.Spread.dll
...
이러한 Error는 Step1 단계 과정의 문제로 발생합니다. 2 개의 dll를 불러오기하여 속성을 변경해야 합니다: Copy Local—True
...
```
 ...
 3:         <Items>
 4:             <FarPoint:MenuItem Text="메뉴1">
 5:             </FarPoint:MenuItem>
 6:             <FarPoint:MenuItem Text="메뉴2">
 7:             </FarPoint:MenuItem>
 8:             <FarPoint:MenuItem Text="메뉴3">
 9:             </FarPoint:MenuItem>
10:         </Items>
