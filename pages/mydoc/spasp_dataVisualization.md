...
![](https://www.grapecity.co.kr/images/training/spread/tc8-1-2.png)
...
막대형 스파크라인는 막대형 차트 방식으로 데이터를 표시하고, 꺾은선형 스파크라인은 꺾은선 차트 형식으로 데이터를 표시합니다. 고저형 스파크라인은 같은 크기의 도형을 사용하여 데이터를 표시하되 데이터값이 플러스일 때는 X축 위에, 마이너스일 때에는 X축 아래에 위치합니다.  
